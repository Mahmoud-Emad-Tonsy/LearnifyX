  ...
  return (
    <div className={Styles['article-card-container']}>
      <Card
        ...
        actions={[
          <LikeIcon
            ...
            liked={liked}
            setLiked={likeThisArticle}
          />,
          <BookMarkIcon
            bookMarked={bookMark}
            setBookMark={BookMarkThisArticle}
            hidden={hidden}
          />,
          <FollowIcon
            followed={follow}
            setFollow={followAuthor}
            hidden={hidden}
          />,
          <Comment
      ...
      >
        ...
        />
        <Card bordered={false}>{Data?.myarticle?.text}</Card>
      </Card>
  ...
  return (
    ...
    >
      {commentState ? (
        ...
        <CommentOutlined style={{ color: '#abb2b9 ' }} />
      )}
    </div>
  )
}
