...
// // Mock email registration endpoint
// app.post('/register', async (req, res) => {
//   try {
//     const { email } = req.body;
//     const confirmationCode = Math.random().toString(36).substring(7);

//     // Simulate storing confirmation code in user's record
//     console.log(`Confirmation code generated for ${email}: ${confirmationCode}`);

//     res.status(200).json({
//       message: 'Email registration successful. Check your email for confirmation instructions.',
//       confirmationCode: confirmationCode
//     });
//   } catch (error) {
//     console.error('Error registering email:', error);
//     res.status(500).json({ error: 'An error occurred while registering email.' });
//   }
// });
